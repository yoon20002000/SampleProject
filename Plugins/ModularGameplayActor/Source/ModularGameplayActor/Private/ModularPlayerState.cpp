...
void AModularPlayerState::CopyProperties(APlayerState* PlayerState)
{
	...
	TInlineComponentArray<UPlayerStateComponent*> Components; UPlayerStateComponent;
	GetComponents(Components);
	for (UPlayerStateComponent* SourcePSComp : Components)
	{
		if(UPlayerStateComponent* TargetComp =
			Cast<UPlayerStateComponent>(
